      ...
      <div className="relative z-10">
        ...
        <div className="flex flex-col space-y-8 text-center sm:space-y-0 sm:flex-row sm:space-x-8 sm:text-left">
          ...
          >
            ...
            Revolutionize Your Industry Landscape
            </h2>
...
crafted uniquely with your data. Revolutionize e-commerce experiences, elevate e-learning platforms, streamline customer support, onboard new team members seamlessly, and much more!
            ...
            >
              <Stack gap={1}>
                ...
                <Typography textColor="text.secondary">
                  <b>Various</b> companies have successfully <br></br>built their
                  custom AI Agent with Dialogs
                </Typography>
              </Stack>
            </Box>
            ...
            <Stack
              ...
              className="justify-center sm:justify-start"
            >
              <Link target="_blank" href={'mailto:klei.aliajc313@gmail.com'}>
                <Button
                  variant="solid"
                  size="lg"
              ...
              <Link
                target="_blank"
                href={'https://calendar.google.com/calendar/u/0?cid=a2xlaS5hbGlhamMzMTNAZ21haWwuY29t'}
              >
                <Button
                  variant="outlined"
                  size="lg"
          ...
          <div className="w-full sm:w-2/3">
            ...
            <iframe
              src="https://dialogg-production.up.railway.app/chatbot/23e3faf7-b3da-4b73-a644-058f0fdfff29"
              width="100%"
              height="100%"
              frameBorder="0"
              ></iframe>
