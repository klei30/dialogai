...
const solutions = [
  {
    ...
    description:
      'Enhance your customer service with AI-driven chatbots that can handle inquiries, complaints, and provide support 24/7. ',
...

  {
    ...
    description: 
      'Design a healthcare advisory chatbot that can answer general health-related queries, and provide preliminary consultations based on the symptoms reported by the users,',
    href: '/#for-healthcare-advisory',
    icon: ServerIcon,
  },

  {
    ...
    description: 
      'Create a chatbot that assists in the education sector by offering personalized learning experiences. It can help learners find resources, answer queries, and even assess performance through quizzes, making learning more interactive and engaging.',
    href: '/#for-learning-and-development',
    icon: (props: any) => (
      <img
        {...props}
